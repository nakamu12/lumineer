...
- [ ] \`docker compose up\` で全サービスが起動する（scope に応じて変更）
- [ ] \`GET /health\` が 200 を返す（該当する場合）"
```

---

## Step 6: GitHub Project にカンバン登録
...
実装完了後は Draft PR を Ready for Review に変更してください。
```
